/*
================================================================================
Script Name:    20260423_ChatbotChartTools.sql
Description:    Seeds permissions for new chart-producing chatbot tools.
...
PRINT '========================================================================';
PRINT 'Seed Chatbot Chart Tool Permissions';
...
BEGIN TRY
    ...
    ('chatbot.tool.get_top_selling_items', N'Tool: Top selling items (ranked)', 'action', 30),
    ('chatbot.tool.get_item_wise_sales',   N'Tool: Item-wise sales (chart)',    'action', 31);
    ...
    PRINT '  [OK] Chart tool permissions inserted (new): ' + CAST(@PermsInserted AS VARCHAR(5));

    COMMIT TRANSACTION;

    PRINT '';
    PRINT '========================================================================';
    PRINT 'Chatbot Chart Tool Permissions Seed - COMPLETED';
    PRINT '';
    PRINT 'NEXT STEPS:';
    PRINT '  1. Assign chatbot.tool.get_item_wise_sales and';
    PRINT '     chatbot.tool.get_top_selling_items to appropriate roles via the';
