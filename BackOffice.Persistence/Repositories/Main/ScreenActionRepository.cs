...
{
    public class ScreenActionRepository : MainBaseRepository<ScreenAction>, IScreenActionRepository
    {
        private readonly MainDBContext _dbContext;
        private readonly IMapper _mapper;
        public ScreenActionRepository(MainDBContext dbContext, IMapper mapper) : base(dbContext, mapper)
