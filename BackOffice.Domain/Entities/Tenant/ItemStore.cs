...
public partial class ItemStore
{
    ...
    public virtual DepartmentStore? Department { get; set; }

    public virtual ItemMain ItemNoNavigation { get; set; } = null!;

    public virtual ItemSpecial? ItemSpecial { get; set; }
    ...
    public virtual ICollection<PriceChangeHistory> PriceChangeHistories { get; set; } = new List<PriceChangeHistory>();

    public virtual Store StoreNoNavigation { get; set; } = null!;
}