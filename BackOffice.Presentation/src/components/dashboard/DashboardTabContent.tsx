...
const componentMap: Record<string, React.LazyExoticComponent<React.ComponentType<any>> | React.ComponentType<any>> = {
  ...
  RegisterListPage: lazy(() => import('../../pages/Registers/RegisterListPage')),
  RegisterFormPage: lazy(() => import('../../pages/Registers/RegisterFormPage')),
  CustomerFormPage: lazy(() => import('../../pages/customers/CustomerFormPage')),
